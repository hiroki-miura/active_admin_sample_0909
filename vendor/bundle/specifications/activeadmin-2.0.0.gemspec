# -*- encoding: utf-8 -*-
# stub: activeadmin 2.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.authors = ["Charles Maresh".freeze, "David Rodr\u{ed}guez".freeze, "Greg Bell".freeze, "Igor Fedoronchuk".freeze, "Javier Julio".freeze, "Piers C".freeze, "Sean Linsley".freeze, "Timo Schilling".freeze]
  s.date = "2019-04-25"
